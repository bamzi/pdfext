...
func init() {
	_f = map[rune]byte{}
	for _bd, _g := range _dc {
		_f[_g] = _bd
	}
}
func PDFDocEncodingToString(b []byte) string { return string(PDFDocEncodingToRunes(b)) }
func StringToUTF16(s string) string {
	_dgb := _b.Encode([]rune(s))
	var _ea _c.Buffer
	for _, _db := range _dgb {
		_ea.WriteByte(byte((_db >> 8) & 0xff))
		_ea.WriteByte(byte(_db & 0xff))
	}
	return _ea.String()
}
func StringToPDFDocEncoding(s string) []byte {
	...
	for _, _fc := range s {
		_ae, _fca := _f[_fc]
		if !_fca {
			_cc.Log.Debug("\u0045\u0052\u0052\u004f\u0052\u003a\u0020\u0050\u0044\u0046\u0044\u006f\u0063\u0045\u006e\u0063\u006f\u0064\u0069\u006eg\u0020\u0072\u0075\u006e\u0065\u0020\u006d\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u006d\u0069\u0073\u0073\u0069\u006e\u0067\u0020\u0025\u0063\u002f\u0025\u0058\u0020\u002d\u0020s\u006b\u0069\u0070\u0070\u0069n\u0067", _fc, _fc)
			continue
		}
		_ab.WriteByte(_ae)
	}
...
func PDFDocEncodingToRunes(b []byte) []rune {
	...
	for _, _ge := range b {
		_cdb, _agf := _dc[_ge]
		if !_agf {
			_cc.Log.Debug("\u0045\u0072\u0072\u006f\u0072\u003a\u0020P\u0044\u0046\u0044o\u0063\u0045\u006ec\u006f\u0064i\u006e\u0067\u0020\u0069\u006e\u0070u\u0074 m\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u0065\u0072\u0072\u006f\u0072\u0020\u0025\u0064\u0020\u002d\u0020\u0073\u006b\u0069\u0070\u0070\u0069\u006e\u0067", _ge)
			continue
		}
		_ag = append(_ag, _cdb)
	}
